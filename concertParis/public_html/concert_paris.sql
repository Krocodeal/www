...
--
-- Client :  localhost
-- Généré le :  Ven 10 Avril 2015 à 11:31
...
(24, '1992-02-18', '', '', '', '', 'RÃ©mi', 'Kro', 'KOCI', 'b6edd10559b20cb0a3ddaeb15e5267cc', 'utilisateur', 'images/event/603126_4361516036972_52832129_n.jpg', 'remikoci@hotmail.fr', '0667031763'),
...
ALTER TABLE `associer`
  ADD PRIMARY KEY (`STYLE_ID`,`EVENEMENT_ID`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`);

--
-- Index pour la table `jouer`
--
ALTER TABLE `jouer`
  ADD PRIMARY KEY (`PERSONNE_ID`,`STYLE_ID`), ADD KEY `STYLE_ID` (`STYLE_ID`);

--
-- Index pour la table `organiser`
--
ALTER TABLE `organiser`
  ADD PRIMARY KEY (`EVENEMENT_ID`,`PERSONNE_ID`), ADD KEY `PERSONNE_ID` (`PERSONNE_ID`);

--
-- Index pour la table `participer`
--
ALTER TABLE `participer`
  ADD PRIMARY KEY (`PERSONNE_ID`,`EVENEMENT_ID`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`);

--
-- Index pour la table `se_produire`
--
ALTER TABLE `se_produire`
  ADD PRIMARY KEY (`PERSONNE_ID`,`EVENEMENT_ID`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`);
...
ALTER TABLE `t_artiste`
  ADD PRIMARY KEY (`PERSONNE_ID`), ADD KEY `PAYS_ID` (`PAYS_ID`);

--
-- Index pour la table `t_evenement`
--
ALTER TABLE `t_evenement`
  ADD PRIMARY KEY (`EVENEMENT_ID`), ADD KEY `LIEU_ID` (`LIEU_ID`);

--
-- Index pour la table `t_favoris`
--
ALTER TABLE `t_favoris`
  ADD PRIMARY KEY (`FAVORIS_ID`);

--
-- Index pour la table `t_gallerie`
--
ALTER TABLE `t_gallerie`
  ADD PRIMARY KEY (`GALLERIE_ID`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`);

--
-- Index pour la table `t_lien`
--
ALTER TABLE `t_lien`
  ADD PRIMARY KEY (`LIEN_ID`), ADD KEY `PERSONNE_ID_1` (`PERSONNE_ID_Artiste`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`), ADD KEY `PERSONNE_ID` (`PERSONNE_ID_Organisation`);
...
--
ALTER TABLE `t_photo`
  ADD PRIMARY KEY (`PHOTO_ID`), ADD KEY `EVENEMENT_ID` (`EVENEMENT_ID`), ADD KEY `GALLERIE_ID` (`GALLERIE_ID`);

--
-- Index pour la table `t_style`
--
ALTER TABLE `t_style`
...
--
ALTER TABLE `t_evenement`
  MODIFY `EVENEMENT_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT pour la table `t_favoris`
--
ALTER TABLE `t_favoris`
  MODIFY `FAVORIS_ID` int(6) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `t_gallerie`
--
ALTER TABLE `t_gallerie`
  MODIFY `GALLERIE_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT pour la table `t_lien`
--
ALTER TABLE `t_lien`
  MODIFY `LIEN_ID` int(6) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `t_lieu`
--
ALTER TABLE `t_lieu`
  MODIFY `LIEU_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT pour la table `t_personne`
--
ALTER TABLE `t_personne`
  MODIFY `PERSONNE_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT pour la table `t_photo`
--
ALTER TABLE `t_photo`
  MODIFY `PHOTO_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT pour la table `t_style`
--
ALTER TABLE `t_style`
  MODIFY `STYLE_ID` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
